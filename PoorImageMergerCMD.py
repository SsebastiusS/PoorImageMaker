...
def main():
    ...
    if args.bulk:
        ...
        print("The grid setting will create MergedOutput without checking if the grid size should be different among subdirectories.")
        print("This may skip some images, improperly sort them, or create empty tiles in merged images if the subdirectories have inconsistent numbers of images.")
